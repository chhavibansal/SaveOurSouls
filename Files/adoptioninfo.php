...
<link rel="stylesheet" type="text/css" media="screen" href="adoptioninfo.css" />
...
<body>
 ...
 if(!$conn){die();}
    ...
    $number=$_GET['person_ID'];
    //  echo $number;
    $sql="SELECT a.breed,a.age,a.gender,a.size,a.color,a.spayed,a.declawed,a.housetrained,a.site,a.location,a.date,a.comment,a.person_ID,p.image FROM adoption a JOIN petimage p ON (a.person_ID=p.person_ID AND a.ID=p.id) where p.person_ID=$number ";
          ...
          ?>
                <table align="left" id="table1" >
                         ...
                         <tr> <td>AGE:</td> <td><?php echo $row["age"];   ?> </td> </tr>
                          ...
                          <tr> <td>SPAYED/NEUTERED:</td> <td><?php echo $row["spayed"];   ?> </td> </tr>
                          <tr> <td>DECLAWED:</td> <td><?php echo $row["declawed"];   ?> </td> </tr>
                          <tr> <td>HOUSE TRAINED:</td> <td><?php echo $row["housetrained"];   ?> </td> </tr>
                          ...
                          <?php echo "<img src='imagex/".$row['image']."' >";   ?>
                      </div>     </td> </tr>
  ...
  ?></div>
  <div class="pdf right">
      <h1 id="h01">Click here to get the adoption form</h1>
 <button id="b01"> <a href="Dog%20Adoption%20Form.pdf">Adopt Now</a></button>

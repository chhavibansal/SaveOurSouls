...
<link rel="stylesheet" type="text/css" media="screen" href="donationrequest.css" />
...
<div class="result-container">
  <?php
  include_once('db.php');
    $sql="SELECT aboutme,reason,illeffect,amount,atmostby,person_ID FROM requestdonation ";
      ...
      while($row=mysqli_fetch_assoc($res))
      {
          ?>
               <table align="left" id="t01"  style="width: 400px; height: 350px;">
                          <tr> <td>About:</td> <td><?php echo $row["aboutme"];   ?> </td> </tr>
                          <tr> <td>Why:</td> <td><?php echo $row["reason"];   ?> </td> </tr>
                          <tr> <td>Illeffect:</td> <td><?php echo $row["illeffect"];   ?> </td> </tr>
                          <tr> <td>Amount:</td> <td><?php echo $row["amount"];   ?>₹ </td> </tr>
                          <tr> <td>Donation Required Atmost By:</td> <td><?php echo $row["atmostby"];   ?> </td> </tr>
